...
if (isset($_POST['submit']) || $_SERVER["QUERY_STRING"] == "dev") {
  ...
  if (isset($_POST['submit']) && $_POST['confirmationCAP'] == "") {
    ...
    if ($result->num_rows == 0 && $result->num_rows == 0) {
      $mysqli->query("INSERT INTO downloads (firstname,lastname,phone,email,uptodate,download_date) VALUES (
  ...
  <article class="download-page">
    <h2>Thank You for Downloading Your Free <?php echo $GLOBALS['demodays']; ?> Day Trial of <span class="redtext">Investment Account Manager</span></h2>
    ...
    <ul style="text-align: left;">
      <li><a href="pdf/Getting_Started_IAMv3_Individual_Demo.pdf">Download our "Getting Started Guide"</a> while using the IAM3 Individual <?php echo $GLOBALS['demodays']; ?> Day Free Trial version.<br><br></li>
